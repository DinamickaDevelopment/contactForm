...
/***/ function(module, exports) {
	...
	module.exports = function () { 
	    ...
	    function change_q() {
	        ...
	        if (r.attr('data-sub') != curr_sub) return false; 
	        console.log('q')
